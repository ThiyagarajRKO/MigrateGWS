...
export const MIGRATION_TEMPLATES = {
  ...
  COMPREHENSIVE_ONE_TO_ONE: {
    mappingType: 'one-to-one' as const,
    services: ['gmail', 'drive', 'calendar', 'groups', 'contacts', 'chat', 'photos', 'forms', 'slides'],
    options: {
      preservePermissions: true,
      preserveSharing: true,
      batchSize: 5,
  ...
  ONE_TO_MANY_DISTRIBUTION: {
    ...
    services: ['drive', 'calendar', 'contacts'],
    options: {
      preservePermissions: true,
      preserveSharing: true,
      batchSize: 3,
