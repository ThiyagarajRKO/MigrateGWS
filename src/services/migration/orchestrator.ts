...
export interface ServiceMigrationOptions {
  ...
  chat?: ChatMigrationOptions;
  photos?: PhotoMigrationOptions;
  forms?: FormsMigrationOptions;
  slides?: SlidesMigrationOptions;
}
...
export class MigrationOrchestrator {
  ...
  private initializeServices(): void {
    ...
    if (this.config.services.includes('chat') && this.options.chat) {
      this.services.set('chat', new ChatMigrationService(
        this.credentials,
        this.config,
        this.options.chat
      ));
    ...
    if (this.config.services.includes('photos') && this.options.photos) {
      this.services.set('photos', new PhotoMigrationService(
        this.credentials,
        this.config,
        this.options.photos
      ));
    ...
    if (this.config.services.includes('forms') && this.options.forms) {
      this.services.set('forms', new FormsMigrationService(
        this.credentials,
        this.config,
        this.options.forms
      ));
    ...
    if (this.config.services.includes('slides') && this.options.slides) {
      this.services.set('slides', new SlidesMigrationService(
        this.credentials,
        this.config,
        this.options.slides
      ));
